...
public class SearchProduct {
	...
	public String  valid_Searching(String product)         //valid search
	{
		...
		driver.findElement(search_textbox).sendKeys(product);     //sending keys to the search text box

		driver.findElement(search_icon).click();					//  clicking  on the search icon
		...
		Searched_product =driver.findElement(product_searched).getText();  // the 1st product displayed after searching
	...
	public String  invalid_Searching(String product)
	{
		...
		Searched_product =driver.findElement(resultpath).getText();		// the error message for invalid search
